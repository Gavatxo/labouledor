  ...
  return (
    <main>
      ...
      <section style={{ position: "relative", minHeight: "82vh", display: "flex", alignItems: "flex-end", overflow: "hidden", background: "var(--ink)" }}>
        ...
        <img src={IMAGES.equipe} alt="" style={{ position: "absolute", inset: 0, width: "100%", height: "100%", objectFit: "cover", objectPosition: "50% 34%", filter: "saturate(.72) contrast(1.02) brightness(.72)" }} />
